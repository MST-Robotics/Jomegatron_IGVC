...
(cl:defmethod cl:initialize-instance :after ((m <IMU>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Midg-msg:<IMU> is deprecated: use Midg-msg:IMU instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:latitude-val is deprecated.  Use Midg-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:longitude-val is deprecated.  Use Midg-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:altitude-val is deprecated.  Use Midg-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:heading-val is deprecated.  Use Midg-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:speed-val is deprecated.  Use Midg-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'angular_rate-val :lambda-list '(m))
(cl:defmethod angular_rate-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:angular_rate-val is deprecated.  Use Midg-msg:angular_rate instead.")
  (angular_rate m))

(cl:ensure-generic-function 'gps_time-val :lambda-list '(m))
(cl:defmethod gps_time-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:gps_time-val is deprecated.  Use Midg-msg:gps_time instead.")
  (gps_time m))

(cl:ensure-generic-function 'position_valid-val :lambda-list '(m))
(cl:defmethod position_valid-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:position_valid-val is deprecated.  Use Midg-msg:position_valid instead.")
  (position_valid m))

(cl:ensure-generic-function 'heading_valid-val :lambda-list '(m))
(cl:defmethod heading_valid-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:heading_valid-val is deprecated.  Use Midg-msg:heading_valid instead.")
  (heading_valid m))

(cl:ensure-generic-function 'speed_valid-val :lambda-list '(m))
(cl:defmethod speed_valid-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:speed_valid-val is deprecated.  Use Midg-msg:speed_valid instead.")
  (speed_valid m))

(cl:ensure-generic-function 'angular_rate_valid-val :lambda-list '(m))
(cl:defmethod angular_rate_valid-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:angular_rate_valid-val is deprecated.  Use Midg-msg:angular_rate_valid instead.")
...
(cl:defmethod position_accuracy-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Midg-msg:position_accuracy-val is deprecated.  Use Midg-msg:position_accuracy instead.")
  (position_accuracy m))
