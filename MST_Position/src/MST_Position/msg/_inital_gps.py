"""autogenerated by genmsg_py from inital_gps.msg. Do not edit."""
import roslib.message
import struct


class inital_gps(roslib.message.Message):
  _md5sum = "ba0fbfca81c6cac39788bbb65f584f05"
  _type = "MST_Position/inital_gps"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(inital_gps, self).__init__(*args, **kwds)
