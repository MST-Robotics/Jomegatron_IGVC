...
void stop_robot();
bool check_togg(bool, wiimote::State);


//checks the button toggle and switches states
//will return true on rising edge of press
bool check_togg(bool button_position, wiimote::State state)
{
    if(state.buttons[button_position] && !wii_togg[button_position])
    {
