...
(cl:defmethod cl:initialize-instance :after ((m <ApplyJointEffort-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ApplyJointEffort-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joe_controller_pkg-srv:<ApplyJointEffort-request> is deprecated: use joe_controller_pkg-srv:ApplyJointEffort-request instead.")))
...
(cl:defmethod effort-val ((m <ApplyJointEffort-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:effort-val is deprecated.  Use joe_controller_pkg-srv:effort instead.")
  (effort m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <ApplyJointEffort-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:start_time-val is deprecated.  Use joe_controller_pkg-srv:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <ApplyJointEffort-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:duration-val is deprecated.  Use joe_controller_pkg-srv:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ApplyJointEffort-request>)))
  ...
  "joe_controller_pkg/ApplyJointEffortRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ApplyJointEffort-request)))
  "Returns string type for a service object of type 'ApplyJointEffort-request"
  "joe_controller_pkg/ApplyJointEffortRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ApplyJointEffort-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ApplyJointEffort-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joe_controller_pkg-srv:<ApplyJointEffort-response> is deprecated: use joe_controller_pkg-srv:ApplyJointEffort-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ApplyJointEffort-response>)))
  ...
  "joe_controller_pkg/ApplyJointEffortResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ApplyJointEffort-response)))
  "Returns string type for a service object of type 'ApplyJointEffort-response"
  "joe_controller_pkg/ApplyJointEffortResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ApplyJointEffort)))
  ...
  "joe_controller_pkg/ApplyJointEffort")