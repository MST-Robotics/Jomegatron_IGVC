...
(cl:defmethod cl:initialize-instance :after ((m <GetLinkState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLinkState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joe_controller_pkg-srv:<GetLinkState-request> is deprecated: use joe_controller_pkg-srv:GetLinkState-request instead.")))

(cl:ensure-generic-function 'link_name-val :lambda-list '(m))
(cl:defmethod link_name-val ((m <GetLinkState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:link_name-val is deprecated.  Use joe_controller_pkg-srv:link_name instead.")
  (link_name m))

(cl:ensure-generic-function 'reference_frame-val :lambda-list '(m))
(cl:defmethod reference_frame-val ((m <GetLinkState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:reference_frame-val is deprecated.  Use joe_controller_pkg-srv:reference_frame instead.")
  (reference_frame m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLinkState-request>)))
  ...
  "joe_controller_pkg/GetLinkStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLinkState-request)))
  "Returns string type for a service object of type 'GetLinkState-request"
  "joe_controller_pkg/GetLinkStateRequest")
...
(cl:defclass <GetLinkState-response> (roslisp-msg-protocol:ros-message)
  ((link_state
    :reader link_state
    :initarg :link_state
    :type gazebo-msg:LinkState
    :initform (cl:make-instance 'gazebo-msg:LinkState))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <GetLinkState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLinkState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joe_controller_pkg-srv:<GetLinkState-response> is deprecated: use joe_controller_pkg-srv:GetLinkState-response instead.")))

(cl:ensure-generic-function 'link_state-val :lambda-list '(m))
(cl:defmethod link_state-val ((m <GetLinkState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:link_state-val is deprecated.  Use joe_controller_pkg-srv:link_state instead.")
  (link_state m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GetLinkState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:success-val is deprecated.  Use joe_controller_pkg-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'status_message-val :lambda-list '(m))
(cl:defmethod status_message-val ((m <GetLinkState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joe_controller_pkg-srv:status_message-val is deprecated.  Use joe_controller_pkg-srv:status_message instead.")
  (status_message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLinkState-response>)))
  ...
  "joe_controller_pkg/GetLinkStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLinkState-response)))
  "Returns string type for a service object of type 'GetLinkState-response"
  "joe_controller_pkg/GetLinkStateResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLinkState-response>)))
  ...
  (cl:format cl:nil "gazebo/LinkState link_state~%bool success~%string status_message~%~%~%================================================================================~%MSG: gazebo/LinkState~%#This message is deprecated.  Please use the version in gazebo_msgs instead.~%~%# @todo: FIXME: sets pose and twist of a link.  All children link poses/twists of the URDF tree are not updated accordingly, but should be.~%string link_name            # link name~%geometry_msgs/Pose pose     # desired pose in reference frame~%geometry_msgs/Twist twist   # desired twist in reference frame~%string reference_frame      # set pose/twist relative to the frame of this link/body~%                            # leave empty or \"world\" or \"map\" defaults to world-frame~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into it's linear and angular parts. ~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLinkState-response)))
  "Returns full string definition for message of type 'GetLinkState-response"
  (cl:format cl:nil "gazebo/LinkState link_state~%bool success~%string status_message~%~%~%================================================================================~%MSG: gazebo/LinkState~%#This message is deprecated.  Please use the version in gazebo_msgs instead.~%~%# @todo: FIXME: sets pose and twist of a link.  All children link poses/twists of the URDF tree are not updated accordingly, but should be.~%string link_name            # link name~%geometry_msgs/Pose pose     # desired pose in reference frame~%geometry_msgs/Twist twist   # desired twist in reference frame~%string reference_frame      # set pose/twist relative to the frame of this link/body~%                            # leave empty or \"world\" or \"map\" defaults to world-frame~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into it's linear and angular parts. ~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLinkState)))
  ...
  "joe_controller_pkg/GetLinkState")