/* Auto-generated by genmsg_cpp for file /home/robot/Code/Jomegatron_IGVC/joe_controller_pkg/srv/GetLinkState.srv */
...
{
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::GetLinkStateRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::GetLinkStateRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::GetLinkStateResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::GetLinkStateResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
