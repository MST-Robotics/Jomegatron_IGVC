/* Auto-generated by genmsg_cpp for file /home/robot/Code/Jomegatron_IGVC/joe_controller_pkg/srv/CommandVelocity.srv */
...
{
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::CommandVelocityRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::CommandVelocityRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::CommandVelocityResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::joe_controller_pkg::CommandVelocityResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
